...
public class _04_CssAndXPath extends TestBase {
    ...
    public void test1() {
        ...
        Locator textSwitchTab = page.locator(".cen-align :text('         switch tab          ')");
        ...
        Locator orLogic = page.locator(":text-is('    Suggession Class example    '), :text-is('    Suggession Class Example    ')");
        System.out.println("orLogic.innerText() = " + orLogic.innerText());
